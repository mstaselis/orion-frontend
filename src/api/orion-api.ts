...
export class Client {
     ...
     */
    retrieve_API_Resources(): Promise<RetrieveApiResourcesResponse> {
    ...
    protected processRetrieve_API_Resources(response: Response): Promise<RetrieveApiResourcesResponse> {
        ...
        return Promise.resolve<RetrieveApiResourcesResponse>(<any>null);
    }
    ...
    protected processList_Entities(response: Response): Promise<ListEntitiesResponse[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<ListEntitiesResponse[]>(<any>null);
    }
     ...
     * @param options (optional) Options dictionary
     */
    create_Entity(content_Type: string, body: CreateEntityRequest, options?: Options4 | null | undefined): Promise<void> {
        let url_ = this.baseUrl + "/v2/entities?";
        if (options !== undefined && options !== null)
            url_ += "options=" + encodeURIComponent("" + options) + "&";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate_Entity(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 204) {
            return response.text().then((_responseText) => {
     ...
     * @param options (optional) Options dictionary
     */
    retrieve_Entity(entityId: string, type?: string | null | undefined, attrs?: string | null | undefined, metadata?: string | null | undefined, options?: Options5 | null | undefined): Promise<RetrieveEntityResponse> {
    ...
    protected processRetrieve_Entity(response: Response): Promise<RetrieveEntityResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<RetrieveEntityResponse>(<any>null);
    }
    ...
    entities with the same entity id.
     */
    remove_Entity(entityId: string, type?: string | null | undefined): Promise<void> {
        let url_ = this.baseUrl + "/v2/entities/{entityId}?";
        if (entityId === undefined || entityId === null)
            throw new Error("The parameter 'entityId' must be defined.");
        url_ = url_.replace("{entityId}", encodeURIComponent("" + entityId));
    ...
    protected processRemove_Entity(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 204) {
            return response.text().then((_responseText) => {
     ...
     * @param options (optional) Options dictionary
     */
    retrieve_Entity_Attributes(entityId: string, type?: string | null | undefined, attrs?: string | null | undefined, metadata?: string | null | undefined, options?: Options7 | null | undefined): Promise<RetrieveEntityAttributesResponse> {
    ...
    protected processRetrieve_Entity_Attributes(response: Response): Promise<RetrieveEntityAttributesResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<RetrieveEntityAttributesResponse>(<any>null);
    }
     ...
     */
    replace_all_entity_attributes(entityId: string, content_Type: string, body: ReplaceAllEntityAttributesRequest, type?: string | null | undefined, options?: Options8 | null | undefined): Promise<void> {
        let url_ = this.baseUrl + "/v2/entities/{entityId}/attrs?";
        if (entityId === undefined || entityId === null)
            throw new Error("The parameter 'entityId' must be defined.");
        url_ = url_.replace("{entityId}", encodeURIComponent("" + entityId));
    ...
    protected processReplace_all_entity_attributes(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 204) {
            return response.text().then((_responseText) => {
     ...
     * @param options (optional) Operations options
     */
    update_or_Append_Entity_Attributes(entityId: string, content_Type: string, body: UpdateOrAppendEntityAttributesRequest, type?: string | null | undefined, options?: Options9 | null | undefined): Promise<void> {
        let url_ = this.baseUrl + "/v2/entities/{entityId}/attrs?";
        if (entityId === undefined || entityId === null)
            throw new Error("The parameter 'entityId' must be defined.");
        url_ = url_.replace("{entityId}", encodeURIComponent("" + entityId));
    ...
    protected processUpdate_or_Append_Entity_Attributes(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 204) {
            return response.text().then((_responseText) => {
     ...
     * @param options (optional) Operations options
     */
    update_Existing_Entity_Attributes(entityId: string, content_Type: string, body: UpdateExistingEntityAttributesRequest, type?: string | null | undefined, options?: Options11 | null | undefined): Promise<void> {
        let url_ = this.baseUrl + "/v2/entities/{entityId}/attrs?";
        if (entityId === undefined || entityId === null)
            throw new Error("The parameter 'entityId' must be defined.");
        url_ = url_.replace("{entityId}", encodeURIComponent("" + entityId));
    ...
    protected processUpdate_Existing_Entity_Attributes(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 204) {
            return response.text().then((_responseText) => {
    ...
    See "Filtering out attributes and metadata" section for more detail.
     */
    get_attribute_data(entityId: string, attrName: string, type?: string | null | undefined, metadata?: string | null | undefined): Promise<GetAttributeDataResponse> {
    ...
    protected processGet_attribute_data(response: Response): Promise<GetAttributeDataResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<GetAttributeDataResponse>(<any>null);
    }
    ...
    entities with the same entity id.
     */
    update_Attribute_Data(entityId: string, attrName: string, content_Type: string, body: UpdateAttributeDataRequest, type?: string | null | undefined): Promise<void> {
        let url_ = this.baseUrl + "/v2/entities/{entityId}/attrs/{attrName}?";
        if (entityId === undefined || entityId === null)
            throw new Error("The parameter 'entityId' must be defined.");
        url_ = url_.replace("{entityId}", encodeURIComponent("" + entityId));
    ...
    protected processUpdate_Attribute_Data(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    entities with the same entity id.
     */
    remove_a_Single_Attribute(entityId: string, attrName: string, type?: string | null | undefined): Promise<void> {
        let url_ = this.baseUrl + "/v2/entities/{entityId}/attrs/{attrName}?";
        if (entityId === undefined || entityId === null)
            throw new Error("The parameter 'entityId' must be defined.");
        url_ = url_.replace("{entityId}", encodeURIComponent("" + entityId));
    ...
    protected processRemove_a_Single_Attribute(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 204) {
            return response.text().then((_responseText) => {
    ...
    entities with the same entity id.
     */
    get_Attribute_Value(entityId: string, attrName: string, type?: string | null | undefined): Promise<GetAttributeValueResponse> {
    ...
    protected processGet_Attribute_Value(response: Response): Promise<GetAttributeValueResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<GetAttributeValueResponse>(<any>null);
    }
    ...
    entities with the same entity id.
     */
    update_Attribute_Value(entityId: string, attrName: string, content_Type: string, body: UpdateAttributeValueRequest, type?: string | null | undefined): Promise<void> {
        let url_ = this.baseUrl + "/v2/entities/{entityId}/attrs/{attrName}/value?";
        if (entityId === undefined || entityId === null)
            throw new Error("The parameter 'entityId' must be defined.");
        url_ = url_.replace("{entityId}", encodeURIComponent("" + entityId));
    ...
    protected processUpdate_Attribute_Value(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @param options (optional) Options dictionary.
     */
    list_Entity_Types(limit?: number | null | undefined, offset?: number | null | undefined, options?: Options13 | null | undefined): Promise<ListEntityTypesResponse[]> {
    ...
    protected processList_Entity_Types(response: Response): Promise<ListEntityTypesResponse[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<ListEntityTypesResponse[]>(<any>null);
    }
     ...
     */
    retrieve_entity_type(entityType: string): Promise<RetrieveEntityTypeResponse> {
    ...
    protected processRetrieve_entity_type(response: Response): Promise<RetrieveEntityTypeResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<RetrieveEntityTypeResponse>(<any>null);
    }
     ...
     * @param options (optional) Options dictionary
     */
    list_Subscriptions(limit?: number | null | undefined, offset?: number | null | undefined, options?: Options14 | null | undefined): Promise<ListSubscriptionsResponse[]> {
    ...
    protected processList_Subscriptions(response: Response): Promise<ListSubscriptionsResponse[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<ListSubscriptionsResponse[]>(<any>null);
    }

    /**
     * Create Subscription
     */
    create_Subscription(content_Type: string, body: CreateSubscriptionRequest): Promise<void> {
        let url_ = this.baseUrl + "/v2/subscriptions";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate_Subscription(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 201) {
            return response.text().then((_responseText) => {
     ...
     */
    retrieve_Subscription(subscriptionId: string): Promise<any> {
    ...
    protected processRetrieve_Subscription(response: Response): Promise<any> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @param subscriptionId subscription Id.
     */
    delete_subscription(subscriptionId: string): Promise<void> {
        let url_ = this.baseUrl + "/v2/subscriptions/{subscriptionId}";
        if (subscriptionId === undefined || subscriptionId === null)
            throw new Error("The parameter 'subscriptionId' must be defined.");
        url_ = url_.replace("{subscriptionId}", encodeURIComponent("" + subscriptionId));
    ...
    protected processDelete_subscription(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 204) {
            return response.text().then((_responseText) => {
     ...
     * @param subscriptionId subscription Id.
     */
    update_Subscription(subscriptionId: string, content_Type: string, body: UpdateSubscriptionRequest): Promise<void> {
        let url_ = this.baseUrl + "/v2/subscriptions/{subscriptionId}";
        if (subscriptionId === undefined || subscriptionId === null)
            throw new Error("The parameter 'subscriptionId' must be defined.");
        url_ = url_.replace("{subscriptionId}", encodeURIComponent("" + subscriptionId));
    ...
    protected processUpdate_Subscription(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 204) {
            return response.text().then((_responseText) => {
     ...
     * @param options (optional) Options dictionary
     */
    list_Registrations(limit?: number | null | undefined, offset?: number | null | undefined, options?: Options15 | null | undefined): Promise<ListRegistrationsResponse[]> {
    ...
    protected processList_Registrations(response: Response): Promise<ListRegistrationsResponse[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<ListRegistrationsResponse[]>(<any>null);
    }

    /**
     * Create Registration
     */
    create_Registration(content_Type: string, body: CreateRegistrationRequest): Promise<void> {
        let url_ = this.baseUrl + "/v2/registrations";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate_Registration(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 201) {
            return response.text().then((_responseText) => {
     ...
     */
    retrieve_Registration(registrationId: string): Promise<RetrieveRegistrationResponse> {
    ...
    protected processRetrieve_Registration(response: Response): Promise<RetrieveRegistrationResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<RetrieveRegistrationResponse>(<any>null);
    }
     ...
     * @param registrationId registration Id.
     */
    delete_Registration(registrationId: string): Promise<void> {
        let url_ = this.baseUrl + "/v2/registrations/{registrationId}";
        if (registrationId === undefined || registrationId === null)
            throw new Error("The parameter 'registrationId' must be defined.");
        url_ = url_.replace("{registrationId}", encodeURIComponent("" + registrationId));
    ...
    protected processDelete_Registration(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 204) {
            return response.text().then((_responseText) => {
     ...
     * @param registrationId registration Id.
     */
    update_Registration(registrationId: string, content_Type: string, body: UpdateRegistrationRequest): Promise<void> {
        let url_ = this.baseUrl + "/v2/registrations/{registrationId}";
        if (registrationId === undefined || registrationId === null)
            throw new Error("The parameter 'registrationId' must be defined.");
        url_ = url_.replace("{registrationId}", encodeURIComponent("" + registrationId));
    ...
    protected processUpdate_Registration(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 204) {
            return response.text().then((_responseText) => {
     ...
     * @param options (optional) Options dictionary
     */
    update(content_Type: string, body: UpdateRequest, options?: Options16 | null | undefined): Promise<void> {
     ...
     * @param options (optional) Options dictionary
     */
    query(content_Type: string, body: QueryRequest, limit?: number | null | undefined, offset?: number | null | undefined, orderBy?: string | null | undefined, options?: Options17 | null | undefined): Promise<QueryResponse[]> {
    ...
    protected processQuery(response: Response): Promise<QueryResponse[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<QueryResponse[]>(<any>null);
    }
     ...
     * @param options (optional) Options dictionary
     */
    notify(content_Type: string, body: NotifyRequest, options?: Options18 | null | undefined): Promise<void> {
